...
public class WebSocketCall {
  ...
  public WebSocketResponse execute(WebSocketListener listener) throws IOException {
    ...
    WebSocket webSocket = createWebSocket(connection, listener);
  ...
  private WebSocket createWebSocket(Connection connection, WebSocketListener listener)
      throws IOException {
    ...
    }, "WebSocketReader " + request.urlString()).start();
